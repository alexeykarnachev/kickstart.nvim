...
require("lazy").setup({
	...
	-- Which-key for keybindings display
	{
	...
	},
	{
		...
		config = function()
			-- LSP attach function for keymaps and settings
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					...
					then
						...
						-- Clear highlights on LSP detach
			...
			-- Configure LSP servers with Mason
	...
	-- Uncomment to load your custom plugins
